...
public class AccessModificator {
    ...
    // Creates a new File in the same dir as targetFile, copies the target file
    // line by line
    // and replaces the first occurrence of the string:(private or protected) of
    // each line with
    // the string public. The target file gets deleted and the new file gets
...
//TODO: na figoun
    ...
    // Creates a new File using the path and name of the file given as a
    // parameter.
